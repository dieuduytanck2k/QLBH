...
namespace QuanLyBanHang
{
    public partial class frmDMHangHoa : Form
    {
        ...
        private void frmDMHangHoa_Load(object sender, EventArgs e)
        {
            ...
            LoadDataGridView();
            Functions.FillCombo(sql, cboMaMayTinh, "MaMayTinh", "TenMayTinh");
            cboMaMayTinh.SelectedIndex = -1;
            ResetValues();
        }
        ...
        private void dgvHang_Click(object sender, EventArgs e)
        {
            ...
            MaMayTinh = dgvHang.CurrentRow.Cells["MaChatLieu"].Value.ToString();
            sql = "SELECT TenMayTinh FROM tblMayTinh WHERE MaMayTinh=N'" + MaMayTinh + "'";
            cboMaMayTinh.Text = Functions.GetFieldValues(sql);
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (cboMaMayTinh.Text.Trim().Length == 0)
            {
                MessageBox.Show("Bạn phải nhập máy tính", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                cboMaMayTinh.Focus();
                return;
            }
            ...
            sql = "INSERT INTO tblHang(MaHang,TenHang,MaMayTinh,SoLuong,DonGiaNhap, DonGiaBan,Anh,Ghichu) VALUES(N'"
                + txtMaHang.Text.Trim() + "',N'" + txtTenHang.Text.Trim() +
                "',N'" + cboMaMayTinh.SelectedValue.ToString() +
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblHang SET TenHang=N'" + txtTenHang.Text.Trim().ToString() +
                "',MaMayTinh=N'" + cboMaMayTinh.SelectedValue.ToString() +
        ...
        {
            string sql;
            if ((txtMaHang.Text == "") && (txtTenHang.Text == "") && (cboMaMayTinh.Text == ""))
            {
            ...
            if (cboMaMayTinh.Text != "")
                sql += " AND MaChatLieu LIKE N'%" + cboMaMayTinh.SelectedValue + "%'";
            tblH = Functions.GetDataToTable(sql);
            if (tblH.Rows.Count == 0)
        ...
        {
            string sql;
            sql = "SELECT MaHang,TenHang,MaMayTinh,SoLuong,DonGiaNhap,DonGiaBan,Anh,Ghichu FROM tblHang";
            tblH = Functions.GetDataToTable(sql);
            dgvHang.DataSource = tblH;
        }
